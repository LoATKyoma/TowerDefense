...
public class ArrowAttact : MonoBehaviour
{
    ...
    void Attact()
    {
        ...
        if (enemys.Count > 0)
        {
            ...
            bullet.GetComponent<ArrowBullet>().SetDamage(GetComponent<TowerLevel>().attackPower, GetComponent<TowerLevel>().isMagicDamage);
            bullet.GetComponent<ArrowBullet>().SetTarget(enemys[0].transform);
        }
        else
        {
            timer = attactRateTime;
